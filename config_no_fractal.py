...
def load_config(parser):
    ...
    ## train_fdm
    ## train xi zeta
    parser.add_argument('--train_xi', nargs='+', type=float, default=[1.0000, 0.8585, 0.5800, 0.2284, 0.0342])
    parser.add_argument('--train_zeta', nargs='+', type=float, default=[0.0000, 0.5128, 0.8146, 0.9736, 0.9994])
    ## train alpha beta
