...
def load_config(parser):
    ...
    ## train_fdm
    ## train alpha beta
    parser.add_argument('--train_alpha', nargs='+', type=float, default=[0.0, 0.3739316623822324, 0.5841135529321078, 0.0, 1.0])
    parser.add_argument('--train_beta', nargs='+', type=float, default=[1.0, 1.3712965250015259, 1.3946171402931213, 1.0, 1.0])
    ## noise gate
    parser.add_argument('--dynamics_noise_gate', action='store_true', default=True)
    parser.add_argument('--dng_id', nargs='+', type=int, default=[1, 2])
    ...
    ## test mix
    parser.add_argument('--test_alpha', nargs='+', type=float, default=[0.0000, 0.27569055543639487, 0.3478207454179226, 0.0000, 0.0000])
    parser.add_argument('--test_beta', nargs='+', type=float, default=[1.0000, 0.9709511995315552, 0.7927531003952026, 1.0000, 1.0000])
    ## tfw
