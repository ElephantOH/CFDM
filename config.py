...
def load_config(parser):
    ...
    ## train_fdm
    ## train alpha beta
    parser.add_argument('--train_alpha', nargs='+', type=float, default=[0.0, 0.3739316623822324, 0.5841135529321078, 0.8099598245764954, 0.9668832692869048])
    parser.add_argument('--train_beta', nargs='+', type=float, default=[1.0, 1.3712965250015259, 1.3946171402931213, 1.2019871324300766, 1.0336449071764946])
    ## noise gate
    ...
    ## test
    parser.add_argument('--test_alpha', nargs='+', type=float, default=[0.0000, 0.2313, 0.3594, 0.4886, 1.0000])
    parser.add_argument('--test_beta', nargs='+', type=float, default=[1.0000, 0.9694, 0.7601, 0.2692, 1.0000])
    ## test zero
    # parser.add_argument('--test_alpha', nargs='+', type=float, default=[0.0, 0., 0., 0.])
