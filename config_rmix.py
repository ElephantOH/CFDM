...
def load_config(parser):
    ...
    ## train_fdm
    ## train alpha beta
    parser.add_argument('--train_alpha', nargs='+', type=float, default=[0.0, 0.2, 0.0, 0.6, 0.0])
    ...
    parser.add_argument('--dng_id', nargs='+', type=int, default=[1, 3])
    parser.add_argument('--dynamics_noise_gate_epoch', type=int, default=0)
    parser.add_argument('--max_dynamic_threshold', type=int, default=0.02)
    ...
    ## test zero
    parser.add_argument('--test_alpha', nargs='+', type=float, default=[0.008791877888143063, 0.07725180685520172, 0.019364330917596817, 0.2467869520187378, 0.0])
    parser.add_argument('--test_beta', nargs='+', type=float, default=[1.0011012554168701, 1.0090878009796143, 0.9895641207695007, 0.725847601890564, 1.0])
    ## tfw
    ...
    parser.add_argument('--cfdm_dataset_size', type=int, default=600)
